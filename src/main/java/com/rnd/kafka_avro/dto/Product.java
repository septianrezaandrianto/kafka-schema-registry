 ...
 */
package com.rnd.kafka_avro.dto;
...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6544745379881446129L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.rnd.kafka_avro.dto\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"double\"},{\"name\":\"ingredient\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"qty\",\"type\":\"int\"}]}");
  ...
  @Deprecated public java.lang.CharSequence ingredient;
   ...
   */
  public Product(java.lang.CharSequence id, java.lang.CharSequence name, java.lang.Double price, java.lang.CharSequence ingredient, java.lang.Integer qty) {
    this.id = id;
    this.name = name;
    this.price = price;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: ingredient = (java.lang.CharSequence)value$; break;
   ...
   */
  public java.lang.CharSequence getIngredient() {
    return ingredient;
  }
   ...
   * @param value the value to set.
   */
  public void setIngredient(java.lang.CharSequence value) {
   ...
   */
  public static com.rnd.kafka_avro.dto.Product.Builder newBuilder() {
    return new com.rnd.kafka_avro.dto.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.rnd.kafka_avro.dto.Product.Builder newBuilder(com.rnd.kafka_avro.dto.Product.Builder other) {
    return new com.rnd.kafka_avro.dto.Product.Builder(other);
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.rnd.kafka_avro.dto.Product.Builder newBuilder(com.rnd.kafka_avro.dto.Product other) {
    return new com.rnd.kafka_avro.dto.Product.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
    ...
    private java.lang.CharSequence ingredient;
    private int qty;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.rnd.kafka_avro.dto.Product.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[3], other.ingredient)) {
        this.ingredient = data().deepCopy(fields()[3].schema(), other.ingredient);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.rnd.kafka_avro.dto.Product other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rnd.kafka_avro.dto.Product.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rnd.kafka_avro.dto.Product.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rnd.kafka_avro.dto.Product.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rnd.kafka_avro.dto.Product.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rnd.kafka_avro.dto.Product.Builder setPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rnd.kafka_avro.dto.Product.Builder clearPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rnd.kafka_avro.dto.Product.Builder setIngredient(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rnd.kafka_avro.dto.Product.Builder clearIngredient() {
      ingredient = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rnd.kafka_avro.dto.Product.Builder setQty(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rnd.kafka_avro.dto.Product.Builder clearQty() {
    ...
    public Product build() {
      try {
        ...
        record.ingredient = fieldSetFlags()[3] ? this.ingredient : (java.lang.CharSequence) defaultValue(fields()[3]);
